        ...
        public async Task CreatesExpectedFiles()
        {
            using (var eventStore = CreateInstance())
            {
                ...
                var expected = new[]
                {
                    ...
                    Path.Combine("Test Directory For Files Event Store", "With Multiple", "Nested Subdirectories", CompetingSequenceWithSameEntityTypeName.EntityTypeName, CompetingSequenceWithSameEntityTypeName.EntityId.ToString(), "Snapshots", "2"),
                    ...
                    Path.Combine("Test Directory For Files Event Store", "With Multiple", "Nested Subdirectories", CompetingSequenceWithSameEntityTypeName.EntityTypeName, CompetingSequenceWithSameEntityTypeName.EntityId.ToString(), "Snapshots", "4"),
                    ...
                    Path.Combine("Test Directory For Files Event Store", "With Multiple", "Nested Subdirectories", CompetingSequenceWithSameEntityId.EntityTypeName, CompetingSequenceWithSameEntityId.EntityId.ToString(), "Snapshots", "1"),
                    ...
                    Path.Combine("Test Directory For Files Event Store", "With Multiple", "Nested Subdirectories", CompetingSequenceWithSameEntityId.EntityTypeName, CompetingSequenceWithSameEntityId.EntityId.ToString(), "Snapshots", "3"),
                    ...
                    Path.Combine("Test Directory For Files Event Store", "With Multiple", "Nested Subdirectories", CompetingSequenceWithSameEntityId.EntityTypeName, CompetingSequenceWithSameEntityId.EntityId.ToString(), "Snapshots", "6")
                }
